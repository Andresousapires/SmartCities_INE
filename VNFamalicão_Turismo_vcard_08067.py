...
dataf = {'Período de referência dos dados': D1,
            ...
            'Atividade económica ': D3,
            #'Grupo etário' : D5,
            'Constituição de pessoas coletivas e entidades equiparadas (N.º)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Turismo'
file = 'dataINE_Turismo_' + vcard + '.csv'
