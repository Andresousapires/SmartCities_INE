...
dataf = {'Período de referência dos dados': D1,
            ...
            'Tipo de veículo': D3,
            #'Sexo' : D5,
            'Veículos novos vendidos por 1000 habitantes (N.º)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Mobilidade'
file = 'dataINE_Mobilidade_' + vcard + '.csv'
