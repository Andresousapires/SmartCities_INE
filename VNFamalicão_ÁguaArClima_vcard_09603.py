...
dataf = {'Período de referência dos dados': D1,
            ...
            'Níveis de tratamento das águas residuais': D3,
            
            'Águas residuais tratadas em estações de tratamento de águas residuais (m^3)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Agricultura'
file = 'dataINE_Agricultura_' + vcard + '.csv'
