...
dataf = {'Período de referência dos dados': D1,
            ...
            'Proporção de alojamentos servidos por tratamento de águas residuais (%)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\ÁguaArClima'
file = 'dataINE_ÁguaArClima_' + vcard + '.csv'
