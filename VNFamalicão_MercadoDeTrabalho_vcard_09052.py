...
dataf = {'Período de referência dos dados': D1,
            ...
            #'Sector de actividade económica': D3,
            #'Sexo' : D5,
            'Proporção da população empregada por conta de outrem com ensino superior (%)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\MercadoDeTrabalho'
file = 'dataINE_MercadoDeTrabalho_' + vcard + '.csv'
