...
for a in range(n_censos):
    ...
    dataf = {'Periodo': D1,
            ...
            #'Sector de execução': D4,
            'Investigadores equivalente a tempo integral (ETI) por 1000 habitantes (N.º)': D5
            }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Ciência'
file = 'dataINE_Ciência_' + vcard + '.csv'
