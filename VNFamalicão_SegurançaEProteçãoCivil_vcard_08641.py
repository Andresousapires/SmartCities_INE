...
dataf = {'Período de referência dos dados': D1,
            ...
            #'Grupo etário' : D5,
            'Índice de gravidade (N.º) dos acidentes de viação com vítimas ': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\SegurançaEProteçãoCivil'
file = 'dataINE_SegurançaEProteçãoCivil_' + vcard + '.csv'
