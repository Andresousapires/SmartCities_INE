...
dataf = {'Período de referência dos dados': D1,
            ...
            'Consumo de combustível automóvel por habitante': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Energia'
file = 'dataINE_Energia_' + vcard + '.csv'
