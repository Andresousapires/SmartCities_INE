...
dataf = {'Período de referência dos dados': D1,
            ...
            'Categoria do alojamento familiar': D3,

            'Valor mediano das vendas por m^2 de alojamentos familiares nos últimos 12 meses': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Habitação'
file = 'dataINE_Habitação_' + vcard + '.csv'
