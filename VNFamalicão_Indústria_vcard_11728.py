...
dataf = {'Período de referência dos dados': D1,
            ...
            'Atividades': D3,
            'Forma jurídica' : D5,
            'Constituição de pessoas coletivas e entidades equiparadas': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Indústria'
file = 'dataINE_Indústria_' + vcard + '.csv'
