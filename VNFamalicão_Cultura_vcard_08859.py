...
dataf = {'Período de referência dos dados': D1,
            ...
            'Tipo de bem imóvel cultural': D3,
            'Número de Bens imóveis culturais': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\Cultura'
file = 'dataINE_Cultura_' + vcard + '.csv'
