...
dataf = {'Período de referência dos dados': D1,
            ...
            #'Tipo de material reciclável': D3,
            #'Grupo etário' : D5,
            'Resíduos urbanos recolhidos selectivamente por habitante (kg/ hab.)': D4
        }
...
path = r'C:\Users\Andre Pires\OneDrive - LCSD - Associação Data Colab\Documentos\código\SmartCity_Famalicao\integradas\ResíduosECircularidade'
file = 'dataINE_ResíduosECircularidade_' + vcard + '.csv'
